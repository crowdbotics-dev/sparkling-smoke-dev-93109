...
## Project Structure
    ...
    ├── sparkling_smoke_dev_93109  # Django project configurations
...
1. Clone this repo and `cd sparkling_smoke_dev_93109`
...
2. Clone this repo and `cd sparkling_smoke_dev_93109`
